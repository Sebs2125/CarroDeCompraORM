...
public class ProductoGestion
{
    ...
    private void inicializarDatos()
    {
        ...
        try
        {
            ...
            if (count == 0)
            {
                ...
                Producto p4 = new Producto("Mouse Logitech", "Mouse inalambrico ergonomico 2400 DPI", 500.0, 50);
                ...
                Producto p5 = new Producto("Teclado Mecanico", "Teclado mecanico RGB switches rojos", 1000.0, 25);
                ...
                Producto p6 = new Producto("Monitor", "Monitor 24 pulgadas Full HD 144Hz", 2000.0, 15);
    ...
    // READ por ID con imagenes y comentarios
    ...
    // READ listado para admin (con imagenes)
    ...
    // READ con paginacion - CORRECCION: JOIN FETCH para cargar imagenes antes de cerrar EntityManager
    public List<Producto> obtenerProductosPaginados(int pagina, int tamano)
    {
        ...
        try
        {
            ...
            List<Long> ids = em.createQuery(
                            "SELECT p.id FROM Producto p ORDER BY p.id", Long.class)
            ...
            // Luego traemos esos productos con sus imagenes ya cargadas
            return em.createQuery(
                            "SELECT DISTINCT p FROM Producto p LEFT JOIN FETCH p.imagenes " +
