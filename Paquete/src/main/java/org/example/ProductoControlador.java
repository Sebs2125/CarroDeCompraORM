...
public class ProductoControlador
{
    ...
    public void mostrarAdminPanel( Context ctx ) //Punto #1 completo hacia abajo: Panel de admin solo es accesible para administradores.
    {
        Usuario usuarioActual = ctx.sessionAttribute("usuarioActual");

        if ( usuarioActual != null || !usuarioActual.isConfirmarAdmin() )
        {
            System.out.println("Acceso denegado al panel admin" );
