...
public class AutenticarUsuarioControlador
{
    ...
    public void login( Context ctx ) //Logica detrás del login, con sus respectivos errores y redirecciones a admin y productos y debajo un logout.
    {
        ...
        if ( user != null ) {
            ...
            System.out.println("Usuario autenticado: " + user.getUsuario() + "-" + user.getNombre() + " (Admin: " + user.isConfirmarAdmin() + ")");
